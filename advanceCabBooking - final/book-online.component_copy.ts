/* Note:
This file is just part of my efforts to get Google Places Address auto-populate to work.
Main difference from the file in use is that this one uses NgZone.run() and the other doesn't.
I found that in this case NgZone.run() did not cause any errors. So I removed it.
